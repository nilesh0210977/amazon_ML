...
<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="margin-bottom:80px">
  <a class="navbar-brand" href="myaccount.php" style="color: #ECF0F1;"><img src="../assets/logogreen.png" alt="Logo" style="width:1.5em; margin: 0% 10% 0% 2%;">&nbsp;CampusConnect-Student</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
   ...
   <div class="collapse navbar-collapse" id="collapsibleNavbar">
	  <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
		  <a class="nav-link" href="naves.in" style="color: #ECF0F1;" download> Download App &#x21E3;</a>
		</li>
		<li class="nav-item">
